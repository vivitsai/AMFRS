...
train_num_dict = {
    ...
    '5': [140, 35, 218, 1632, 62, 445, 241, 40, 108, 123, 110, 89, 225, 73, 10, 72, 30, 32, 87, 34, 13, 40],
                  }
...
class_name_dict = {
    ...
    '5': ['Red roof', 'Road', 'Bare soil', 'Cotton',
          'Cotton firewood', 'Rape', 'Chinese cabbage', 'Pakchoi', 'Cabbage', 'Tuber mustard',
...
disjoint_data_path_dir = {
    ...
    '4': [['Dataset/Salinas_corrected.mat', 'x'],
          ['Dataset/Salinas_gt.mat', 'y']],
    '5': [['Dataset/WHU_Hi_HongHu.mat', 'x'],
          ['Dataset/WHU_Hi_HongHu_train_gt.mat', 'y'],
          ['Dataset/WHU_Hi_HongHu_test_gt.mat', 'y']],
}
...
def generate_fixed_train_test_batch(dataID=1, num_PC=4, w=11, batch_size=64):
    ...
    return (train_idx, generate_batch(train_idx, X_PCAMirrow, Y_train, train_batch_size, shuffle=True), train_step, generate_batch(test_idx, X_PCAMirrow, Y_test, batch_size), test_step)
